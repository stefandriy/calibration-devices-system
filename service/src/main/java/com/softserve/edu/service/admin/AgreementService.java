...
public interface AgreementService {
    ...
    Agreement add(Organization customer, Organization executor, String number, Long deviceCount, Date date, DeviceType deviceType);

    Agreement add(Long customerId, Long executorId, String number, Long deviceCount, Date date, DeviceType deviceType);
