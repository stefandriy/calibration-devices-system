	...
	public class NewVerificationsQueryConstructorCalibrator {
		...
		public static CriteriaQuery<Verification> buildSearchQuery(Long providerId, String startDateToSearch,
																   ...
																   User calibratorEmployee, String standardSize, String symbol, String nameProvider, String realiseYear, String dismantled, String building, String sortCriteria, String sortOrder, String employeeSearchName, EntityManager em, ArrayList<Map<String, String>> globalSearchParams) {
