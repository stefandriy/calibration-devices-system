...
public class OrganizationsService {
	...
	public void addOrganizationWithAdmin(String name, String email,
			String phone, String[] types, Integer employeesCapacity, String username, String password,
			Address address) {

		Organization organization = new Organization(name, email, phone, employeesCapacity,
				address);
	...
	public void editOrganization(Long organizationId, String name,
			String phone, String email, Integer employeesCapacity, Address address) {
